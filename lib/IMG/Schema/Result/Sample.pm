package IMG::Schema::Result::Sample;
...
Related object: L<IMG::Schema::Result::Metaread>
...
Related object: L<IMG::Schema::Result::Project>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:1dPpBhsMEFgHngxRsBHlrg
